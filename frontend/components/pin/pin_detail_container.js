...
import { createPinning, deletePinningInPin, deletePinningInBoard } from '../../actions/pinning_actions';
...
const mapDispatchToProps = dispatch => ({
  ...
  deletePinningInPin: pinning => dispatch(deletePinningInPin(pinning)),
